    ...
    <form method="Post" action="../../user/pages/Account/AccountLogic.php?userId=<?php echo $_SESSION['userId']; ?>"  enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-4 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="100px" <?php echo 'src=' . $userImage . ' alt="UserImg"' ?>> <span class="font-weight-bold"><?php echo $row['username'] ?></span><span class="text-black-50">
                        <?php echo $row['email'] ?>
                    </span><span> </span></div>
            </div>
